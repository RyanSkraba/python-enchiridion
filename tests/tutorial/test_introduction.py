...
class Tutorial3Introduction(unittest.TestCase):
    ...
    def testStringFormats(self):
        ...
        self.assertEqual('"You\'re sure?" she asked.', "\"You're sure?\" she asked.",
                         msg="embedded")
...
Purge them, scourge them, burnish brightly,\n\
  Then in love set each one free."
        ...
        expected = "Catch your thoughts and hold them tightly,\n  Let each one an " \
                   "honor be;\nPurge them, scourge them, burnish brightly,\n  Then in " \
...
Purge them, scourge them, burnish brightly,
  Then in love set each one free.'''
        self.assertEqual(expected, actual, msg="triple quote '''")
        ...
        actual = r"Catch your thoughts and hold them tightly,\n  Let each one an " \
                 r"honor be;"
        expected = "Catch your thoughts and hold them tightly,\\n  Let each one an honor be;"
    ...
    def testLists(self):
        ...
        a[:0] = a
        self.assertEquals(a, [123, 'bletch', 'xyzzy', 1234, 123,
                              'bletch', 'xyzzy', 1234])
